...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-between p-8 space-y-12">
      <div className="self-start w-full flex items-center space-x-4 justify-end pr-20">
        <LanguageSelect
      ...
      <header className="flex flex-col items-center space-y-4">
        <h1 className="text-4xl font-bold flex items-center gap-2">{translateText('titleHero')}<strong>RTK-Translate</strong>
      ...
      <section className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 w-full">
        ...
        <div className="p-6 border rounded shadow-md hover:shadow-lg transition">
          ...
          <p className="text-gray-600">{translateText('descriptionCardThree')}
            <a href='https://www.npmjs.com/package/react-flag-kit' target='_blank' className='text-white transition-all ease-linear duration-200 hover:border-b'> react-flag-kit</a>
          </p>
        </div>
        <div className="p-6 border rounded shadow-md hover:shadow-lg transition">
